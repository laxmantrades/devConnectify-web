...
const ViewProject=()=>{
    ...
    if(!data) return
    const {skills,projectName,description,photoUrl,creator,projectImage}=data?.project
    return(<div className="flex items-center justify-center mt-2">
            <div className=" container w-2/3 ">
                ...
                <div className="mt-5">
                    <img src={projectImage ||"https://trekmag.co.uk/wp-content/uploads/What-is-a-Project-1-scaled-1.jpg"}/>
                </div>
                <div>
